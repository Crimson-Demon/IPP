...
/*---------------------------------------------------------------------------*/
//GENERAL GAME PURPOSE DATA STRUCTURES
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
//GENRAL GAME PURPOSE FUNCTIONS AND METHODS
/*---------------------------------------------------------------------------*/
/**
...
/*---------------------------------------------------------------------------*/
/**
 The king observes the battle and if a knight is close to him, he moves away to a safe spot.
 */
void king_acts();

/**
 Knights are ordered to attack the closest unit to the king.
 Each turn, they mark the closest unit to them and charge at it.
 Each knight marks only one unit per turn.
 * @param[in] knights_list List of AI's knights.
 */
void knights_act();

/**
 Peasants are ordered to produce. If one peasant, then he produces another. If two, then they produce knights.
 * @param[in] knights_list List of AI's peasants.
 */
void peasants_act();

/**
 Aggregate function for all the actions the AI does during their turn.
 */
void do_actions();
